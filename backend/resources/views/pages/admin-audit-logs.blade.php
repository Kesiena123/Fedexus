...
@section('content')
    <x-dashboard-shell title="Audit Logs">
        <div class="flex flex-col items-center justify-center rounded-3xl border border-dashed border-slate-300 bg-white/60 p-16 text-center">
            ...
            <h3 class="mt-4 text-lg font-semibold text-navy-900">Audit Logs</h3>
            <p class="mt-2 max-w-md text-sm text-slate-500">System-wide audit trail, user activity logs, and event history coming soon.</p>
        </div>
    </x-dashboard-shell>
@endsection