...
@section('content')
    <x-dashboard-shell title="Staff Management">
        <div class="flex flex-col items-center justify-center rounded-3xl border border-dashed border-slate-300 bg-white/60 p-16 text-center">
            ...
            <h3 class="mt-4 text-lg font-semibold text-navy-900">Staff Management</h3>
            <p class="mt-2 max-w-md text-sm text-slate-500">Staff accounts, permissions, and activity monitoring tools coming soon.</p>
        </div>
    </x-dashboard-shell>
@endsection